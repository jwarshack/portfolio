...
function Hero() {
  return (
    <div className='bg-[#ff8e71] lg:bg-transparent pt-10 md:pt-0 flex flex-col-reverse gap-6 lg:gap-0 lg:flex-row justify-center h-screen w-full'>
      <div className='bg-transparent lg:bg-[#ff8e71] w-full flex items-center justify-center'>
      ...
      <div className= 'bg-transparent lg:bg-[#fe734e] w-full flex items-center justify-center relative'>
